...
![QQ plot](/Example_QQ.png){:height="50%" width="50%"}
...
![Manhattan plot](/Example_Manhattan.png){:height="50%" width="50%"}
...
![Manhattan plot](/Example_PowerAnalysis.png){:height="50%" width="50%"}
